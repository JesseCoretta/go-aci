...
func aciparserParserInit() {
	...
	staticData.serializedATN = []int32{
		...
		1, 0, 0, 0, 54, 55, 1, 0, 0, 0, 55, 56, 1, 0, 0, 0, 56, 57, 5, 23, 0, 0,
		57, 58, 5, 35, 0, 0, 58, 59, 3, 26, 13, 0, 59, 61, 5, 26, 0, 0, 60, 62,
		3, 4, 2, 0, 61, 60, 1, 0, 0, 0, 62, 63, 1, 0, 0, 0, 63, 61, 1, 0, 0, 0,
		63, 64, 1, 0, 0, 0, 64, 65, 1, 0, 0, 0, 65, 66, 5, 24, 0, 0, 66, 3, 1,
		0, 0, 0, 67, 68, 3, 6, 3, 0, 68, 69, 3, 24, 12, 0, 69, 70, 5, 26, 0, 0,
		70, 5, 1, 0, 0, 0, 71, 72, 7, 0, 0, 0, 72, 73, 3, 46, 23, 0, 73, 78, 3,
		8, 4, 0, 74, 75, 5, 25, 0, 0, 75, 77, 3, 8, 4, 0, 76, 74, 1, 0, 0, 0, 77,
		80, 1, 0, 0, 0, 78, 76, 1, 0, 0, 0, 78, 79, 1, 0, 0, 0, 79, 81, 1, 0, 0,
		0, 80, 78, 1, 0, 0, 0, 81, 82, 3, 48, 24, 0, 82, 7, 1, 0, 0, 0, 83, 84,
		7, 1, 0, 0, 84, 9, 1, 0, 0, 0, 85, 86, 3, 46, 23, 0, 86, 87, 3, 44, 22,
		0, 87, 88, 3, 12, 6, 0, 88, 89, 3, 26, 13, 0, 89, 90, 3, 48, 24, 0, 90,
		11, 1, 0, 0, 0, 91, 94, 3, 38, 19, 0, 92, 94, 3, 40, 20, 0, 93, 91, 1,
		0, 0, 0, 93, 92, 1, 0, 0, 0, 94, 13, 1, 0, 0, 0, 95, 97, 3, 10, 5, 0, 96,
		95, 1, 0, 0, 0, 97, 98, 1, 0, 0, 0, 98, 96, 1, 0, 0, 0, 98, 99, 1, 0, 0,
		0, 99, 15, 1, 0, 0, 0, 100, 101, 3, 42, 21, 0, 101, 102, 3, 28, 14, 0,
		102, 103, 3, 26, 13, 0, 103, 111, 1, 0, 0, 0, 104, 105, 3, 46, 23, 0, 105,
		106, 3, 42, 21, 0, 106, 107, 3, 28, 14, 0, 107, 108, 3, 26, 13, 0, 108,
		109, 3, 48, 24, 0, 109, 111, 1, 0, 0, 0, 110, 100, 1, 0, 0, 0, 110, 104,
		1, 0, 0, 0, 111, 17, 1, 0, 0, 0, 112, 113, 5, 50, 0, 0, 113, 19, 1, 0,
		0, 0, 114, 115, 5, 51, 0, 0, 115, 21, 1, 0, 0, 0, 116, 117, 5, 52, 0, 0,
		117, 23, 1, 0, 0, 0, 118, 119, 6, 12, -1, 0, 119, 120, 3, 46, 23, 0, 120,
		121, 3, 24, 12, 0, 121, 122, 3, 48, 24, 0, 122, 136, 1, 0, 0, 0, 123, 130,
		3, 16, 8, 0, 124, 127, 3, 18, 9, 0, 125, 127, 3, 20, 10, 0, 126, 124, 1,
		0, 0, 0, 126, 125, 1, 0, 0, 0, 127, 128, 1, 0, 0, 0, 128, 129, 3, 16, 8,
		0, 129, 131, 1, 0, 0, 0, 130, 126, 1, 0, 0, 0, 131, 132, 1, 0, 0, 0, 132,
		130, 1, 0, 0, 0, 132, 133, 1, 0, 0, 0, 133, 136, 1, 0, 0, 0, 134, 136,
		3, 16, 8, 0, 135, 118, 1, 0, 0, 0, 135, 123, 1, 0, 0, 0, 135, 134, 1, 0,
		0, 0, 136, 143, 1, 0, 0, 0, 137, 138, 10, 3, 0, 0, 138, 139, 3, 22, 11,
		0, 139, 140, 3, 24, 12, 3, 140, 142, 1, 0, 0, 0, 141, 137, 1, 0, 0, 0,
...
func (s *InstructionContext) LPAREN() antlr.TerminalNode {
...
func (s *InstructionContext) RPAREN() antlr.TerminalNode {
